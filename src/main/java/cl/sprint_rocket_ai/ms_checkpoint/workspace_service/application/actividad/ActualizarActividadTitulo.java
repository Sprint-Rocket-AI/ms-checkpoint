...
@Service
public final class ActualizarActividadTitulo {

    private static final Logger log = LoggerFactory.getLogger(ActualizarActividadTitulo.class);

    private final ActividadMongoRepository actividadRepository;

    public ActualizarActividadTitulo(ActividadMongoRepository actividadRepository) {
        this.actividadRepository = actividadRepository;
    }

    public ActividadResponse execute(String id, ActualizarActividadTituloRequest request) {
        log.info("Actualizando título de actividad id={}", id);
