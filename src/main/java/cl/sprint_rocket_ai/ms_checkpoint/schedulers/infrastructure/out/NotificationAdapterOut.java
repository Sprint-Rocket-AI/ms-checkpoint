...
import jakarta.mail.internet.MimeMessage; // 👈 Cambio de importación para HTML
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.mail.javamail.JavaMailSender;
import org.springframework.mail.javamail.MimeMessageHelper; // 👈 Cambio de importación para HTML
import org.springframework.stereotype.Component;

import java.util.List;

/**
 * Adaptador de notificaciones usando JavaMailSender compatible con HTML.
 */
@Component
public final class NotificationAdapterOut implements NotificationPortOut {
    ...
    public NotificationAdapterOut(JavaMailSender mailSender) {
    ...
    // 🛠️ MÉTODO MODIFICADO PARA SOPORTAR HTML Y TEXTO PLANO AL MISMO TIEMPO
    private void sendEmail(String to, String subject, String text) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            // El parámetro 'true' indica que es un mensaje multipart (permite HTML y adjuntos)
            ...
            // El segundo parámetro en 'true' le dice a Spring que el contenido es HTML 🚀
            // Si el texto enviado no tiene etiquetas HTML, se renderizará igual como texto plano normal.
